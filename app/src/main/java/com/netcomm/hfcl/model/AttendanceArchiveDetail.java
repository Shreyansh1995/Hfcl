...
public class AttendanceArchiveDetail {
    ...
    public AttendanceArchiveDetail(String empName, String period, String RMStatus, String regularisationType, String reqDate, String reqID, String reqNo, String type) {
        EmpName = empName;
        Period = period;
