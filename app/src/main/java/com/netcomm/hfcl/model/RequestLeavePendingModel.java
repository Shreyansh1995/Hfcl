...
public class RequestLeavePendingModel {
    ...
    public RequestLeavePendingModel(String empName, String noOfLeave, String period, String RMStatus, String regularisationType, String reqDate, String reqID, String reqNo, String type) {
        EmpName = empName;
        NoOfLeave = noOfLeave;
        Period = period;
