...
public class AttendanceRegularizationListAdapter extends BaseAdapter implements ResponseListener {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
      ...
      //  holder.tv_rd_req_code.setText(data.getReqNo() + "    |    " + data.getReqDate());
    ...
    public void onSuccess(JSONObject obj, int Tag) {
        ...
        if (obj.optString("Status").equals("true")) {
            ...
            } else if (Tag == UrlConstants.CANCEL_ATTENDANCE_ATTENDANCE_REQUEST_TAG) {
    ...
    void popUpForvehicleList(final AttendanceRequestViewModel data) {
        ...
        View dialogView = inflater.inflate(R.layout.popup_view_request_detail, null);
      ...
      //  TextView tv_to_date = (TextView) dialogView.findViewById(R.id.tv_to_date);
       ...
       // tv_to_time.setText(data.getTotime());
        ...
        /****************************************************/
        if (data.getCancelPanelIsVisable().equals("false")) {
            tv_cancel_request.setVisibility(View.GONE);
        }
        if (!data.getCancelDate().equals("")) {
            ll_cancel_date.setVisibility(View.VISIBLE);
            tv_cancel_date_text.setText(data.getCancelStatus()+" on "+data.getCancelDate());
        } else {
    ...
    void hitApiForCancelRequest(String reqId) {
        try {
            request = new ProjectWebRequest(mContext, getParamForCancelRequest(reqId), UrlConstants.CANCEL_ATTENDANCE_ATTENDANCE_REQUEST, this, UrlConstants.CANCEL_ATTENDANCE_ATTENDANCE_REQUEST_TAG);
            request.execute();
        } catch (Exception e) {
            clearRef();
            e.printStackTrace();
    ...
    public void openWarnAlertForCancelRequest(View view, final AttendanceRequestViewModel data,final AlertDialog dialog) {
