...
public class ArchivedAttendanceRequestAdapter extends BaseAdapter implements ResponseListener {
    ...
    private ArrayList<AttendanceArchiveDetail> list;
    private int selectedPosition;
    private ProjectWebRequest request;

    public ArchivedAttendanceRequestAdapter(Context mContext, ArrayList<AttendanceArchiveDetail> list) {
    ...
    @Override
    public AttendanceArchiveDetail getItem(int position) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.archive_attendance_request_item, null);
            ...
            holder.tv_ar_regu_type = (TextView) convertView.findViewById(R.id.tv_ar_regu_type);
        ...
        holder.tv_ar_regu_type.setText(list.get(position).getRegularisationType());
       // holder.tv_ar_period.setText(list.get(position).getPeriod());
        if(list.get(position).getRegularisationType().equals("Mis-Punch")){
            String parts[]=list.get(position).getPeriod().split("-");
            String  fdate=parts[0];
            holder.tv_ar_period.setText("Reg Date: " + fdate);
        }else{
            holder.tv_ar_period.setText("Reg Date: " + list.get(position).getPeriod());
        }

        convertView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                hitApiForViewDetail(list.get(position).getReqID());
